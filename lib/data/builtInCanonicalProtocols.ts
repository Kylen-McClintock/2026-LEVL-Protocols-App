...
export const CANONICAL_PATRICK_MODALITIES: Modality[] = [
  {
    ...
    display_name: 'Hyperthermic Sauna Conditioning',
    category: 'recovery',
  ...
  },
  {
    ...
    display_name: 'Vitamin D3 + Vitamin K2 (MK-7)',
    category: 'supplements',
    modality_type: 'supplement',
    status: 'active',
  ...
  },
  {
    ...
    display_name: 'Vigorous High-Intensity Sprints (HIIT)',
    category: 'fitness',
    modality_type: 'hiit',
    status: 'active',
...
export const CANONICAL_SINCLAIR_MODALITIES: Modality[] = [
  ...
  },
  {
    ...
    display_name: 'Micronized Trans-Resveratrol',
    category: 'supplements',
    modality_type: 'supplement',
    status: 'active',
