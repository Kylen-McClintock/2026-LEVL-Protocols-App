...
export function evaluateDailyBandwidth({
  ...
  if (suggestedMode === 'survival_80_20') {
    ...
    for (const task of todayTasks) {
      ...
      if (
        ...
        adjustments.push({
          ...
          type: 'downgrade',
          title: `Swap: ${name} ➔ 15-min Restorative Mobility Walk`,
          category: 'fitness',
          badge: 'Allostatic Relief',
          badgeColor: 'text-amber-300 bg-amber-500/20 border-amber-500/40',
          impact: 'Saves 45 mins & eliminates central nervous system burnout',
          description: 'Replaces heavy eccentric spinal loading with light parasympathetic aerobic movement to preserve joint health.',
        ...
        adjustments.push({
          ...
          type: 'downgrade',
          title: `Downgrade: ${name} ➔ 60s Cool Face/Shower Rinse`,
          category: 'thermal',
          badge: 'Adrenergic Protection',
          badgeColor: 'text-cyan-300 bg-cyan-500/20 border-cyan-500/40',
          impact: 'Saves cold tub preparation & spares catecholamines',
          description: 'Spares your already depleted sympathetic nervous system while still offering mild vagal stimulation.',
        ...
        adjustments.push({
          ...
          type: 'cut',
          title: `Defer: ${name} to Tomorrow`,
          category: 'fitness',
          badge: 'Cardiac Protection',
          badgeColor: 'text-rose-300 bg-rose-500/20 border-rose-500/40',
          impact: 'Saves high myocardial load',
          description: 'Defers anaerobic lactic sprints to when cardiovascular autonomic reserve has rebounded.',
        ...
        adjustments.push({
          ...
          type: 'downgrade',
          title: `Shorten Fasting Window to Gentle 12:12`,
          category: 'lifestyle',
    ...
    adjustments.push({
      ...
      title: 'Add: Creatine Monohydrate (+10g Cognitive Rescue Dose)',
      category: 'supplement',
      badge: 'Cerebral Bioenergetics',
    ...
    adjustments.push({
      id: 'add_nsdr_rest',
      type: 'add_restorative',
      title: 'Add: 20-min Non-Sleep Deep Rest (NSDR / Yoga Nidra)',
      category: 'recovery',
      badge: 'Dopamine & Vagal Rebound',
    ...
    adjustments.push({
      id: 'add_vo2max_surge',
      type: 'add_surge',
      title: 'Add: Norwegian 4x4 VO2 Max Interval Burst',
      category: 'fitness',
      badge: 'Max Longevity ROI',
      badgeColor: 'text-rose-300 bg-rose-500/20 border-rose-500/40',
    ...
    adjustments.push({
      ...
      type: 'add_surge',
      title: 'Extend: Finnish Sauna to 25 mins at 174°F+',
      category: 'thermal',
      badge: 'Heat Shock Surge',
      badgeColor: 'text-amber-300 bg-amber-500/20 border-amber-500/40',
