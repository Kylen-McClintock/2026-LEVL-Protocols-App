...
export default function TodayError({
  ...
  useEffect(() => {
    console.error('Captured error in /today boundary:', error)
  }, [error])
      ...
      <div className="max-w-md w-full rounded-2xl bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 border border-slate-800 p-6 sm:p-8 shadow-2xl relative overflow-hidden text-center space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-xl sm:text-2xl font-black text-white tracking-tight">
            Schedule View Temporarily Interrupted
          </h2>
          <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
            A temporary sync delay or stale browser cache interrupted loading today’s schedule. You can reload or reset the local cache below.
          </p>
        </div>
        ...
        <div className="space-y-3 pt-2">
          ...
          >
            ...
            <span>Clear Local Cache &amp; Refresh</span>
          </button>

          <button
            type="button"
            onClick={() => {
              if (typeof window !== 'undefined') window.location.href = '/huberman'
            }}
        ...
        {/* Expandable Technical Diagnostic Box */}
