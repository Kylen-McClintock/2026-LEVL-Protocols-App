...
async function main() {
  console.log('--- Seeding 3 Flagship Functional Protocols & 12 Modalities to Remote Supabase ---')
  ...
  // D. Append Idempotent SQL to docs/update_longevity_outcomes.sql
  console.log(`\n4. Generating idempotent SQL block for docs/update_longevity_outcomes.sql...`)
  const sqlAppend = `

-- =========================================================================
-- 3 FLAGSHIP FUNCTIONAL OUTCOME PROTOCOLS & 12 CLINICAL MODALITIES (2026)
-- 1. Gut Microbiome Diversity & Barrier Sealing (Dr. Sonnenburg & Huberman)
-- 2. Glymphatic Clearance & Deep Slow-Wave Waste Detox (Prof. Nedergaard)
-- 3. Retinal Mitochondrial Photoreceptor Rejuvenation (Prof. Glen Jeffery)
-- =========================================================================

-- Upsert 12 Functional Longevity Modalities
...
`
  ...
  console.log(`✓ Idempotent SQL statements successfully appended to docs/update_longevity_outcomes.sql`)
