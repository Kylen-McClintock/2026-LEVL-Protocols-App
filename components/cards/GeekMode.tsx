    ...
    <div className="bg-black/40 rounded-xl p-4 border border-levl-purple/20 space-y-4 animate-in fade-in slide-in-from-top-2 mt-4 text-sm">
      ...
      <div className="pt-4 border-t border-white/10 mt-3">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-between p-3.5 rounded-2xl bg-gradient-to-r from-purple-950/70 via-indigo-950/40 to-slate-900 border border-purple-500/40 hover:border-purple-400 text-purple-200 hover:text-white transition-all group shadow-md"
        >
          ...
          <ExternalLink size={14} className="text-slate-500 group-hover:text-purple-300 transition-colors shrink-0 ml-2" />
        </a>
      </div>
